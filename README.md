Clear Journal Abbrev
=================

Install by downloading the [latest version](https://github.com/retorquere/zotero-clear-journal-abbrev/releases/latest)

Clear journal abbreviation of selected items
